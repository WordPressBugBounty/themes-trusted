...
define( 'TRUSTED_VERSION', wp_get_theme()->get( 'Version' ) );
...
function trusted_scripts() {
	...
	wp_enqueue_script( 'trusted-custom', get_template_directory_uri() . '/js/trusted-custom.js', array( 'jquery' ), TRUSTED_VERSION, true );
	...
	wp_enqueue_style( 'trusted-style', get_stylesheet_uri(), '', TRUSTED_VERSION );
...
function trusted_enqueue_gutenberg_block_editor_assets() {
	...
	wp_enqueue_style( 'trusted-block-editor-style', get_template_directory_uri() . '/css/block-editor-style.css', array(), TRUSTED_VERSION );
...
function trusted_reg_plugin() {
	$plugins[] = array(
		'name'		=> esc_html__( 'Classic Editor', 'trusted' ),
		'slug'		=> 'classic-editor',
		'required'	=> false,
	);
	$plugins[] = array(
		'name'		=> esc_html__( 'Classic Widgets', 'trusted' ),
